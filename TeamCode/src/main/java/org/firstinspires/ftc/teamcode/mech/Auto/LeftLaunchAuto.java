...
public class LeftLaunchAuto extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double interballDistance = 8;
        double farRowY = 12;
        double midRowY = -12;
        double closeRowY = -36;
        double firstBallX = -43+interballDistance;
        ...
        class RobotMechanisms {
            ...
            Pose2d shootLocation = new Pose2d(-37,37, Math.toRadians(135));
            Vector2d shootVector = new Vector2d(-37,37);
            Vector2d farRow1 = new Vector2d(firstBallX+3*interballDistance, farRowY);
            ...
            Pose2d farRow1End = new Pose2d(firstBallX+3*interballDistance,farRowY, Math.toRadians(180));
            ...
            Vector2d midRow1 = new Vector2d(firstBallX+3*interballDistance, -midRowY);
            ...
            Pose2d midRow1End = new Pose2d(firstBallX+3*interballDistance,midRowY, Math.toRadians(180));
            ...
            Vector2d closeRow1 = new Vector2d(firstBallX+3*interballDistance, closeRowY);
            ...
            Pose2d closeRow1End = new Pose2d(firstBallX+3*interballDistance,closeRowY, Math.toRadians(180));
            ...
            public Action Shoot() {
                return new Action() {
                    ...
                    public boolean run(TelemetryPacket packet) {
                        ...
                        if (timer.seconds() > 1.5 && timer2.seconds() < 2.5) {
            ...
            Action trajectoryCollectRow1_2 = Drivetrain.actionBuilder(farRow2End)
                    // .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(farRow3, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow1_3 = Drivetrain.actionBuilder(farRow3End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(farRow4, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow2_1 = Drivetrain.actionBuilder(midRow1End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(midRow2, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow2_2 = Drivetrain.actionBuilder(midRow2End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(midRow3, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow2_3 = Drivetrain.actionBuilder(midRow3End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(midRow4, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow3_1 = Drivetrain.actionBuilder(closeRow1End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(closeRow2, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow3_2 = Drivetrain.actionBuilder(closeRow2End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(closeRow3, Math.toRadians(180), tvConstraint)
                    .build();
            Action trajectoryCollectRow3_3 = Drivetrain.actionBuilder(closeRow3End)
                    .waitSeconds(ballWaiting)
                    .strafeToLinearHeading(closeRow4, Math.toRadians(180), tvConstraint)
                    .build();
            ...
            Action Trajectoryrow1 = Drivetrain.actionBuilder(shootLocation)
                    .strafeToLinearHeading(farRow1, Math.toRadians(180))
                    .build();

            Action Trajectoryrow2 = Drivetrain.actionBuilder(shootLocation)
                    .strafeToLinearHeading(midRow1, Math.toRadians(180))
                    .build();
            Action Trajectoryrow3 = Drivetrain.actionBuilder(shootLocation)
                    .strafeToLinearHeading(closeRow1, Math.toRadians(180))
                    .build();
